...
Автоматически созданная документация по классам и интерфейсам (на английском :uk: :us:) доступна [здесь](https://htmlpreview.github.io/?https://github.com/mickfierte/XData/blob/master/docs/html/index.html)
