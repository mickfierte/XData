...
> Возможность описания преобразования для интерфейсов-маркеров позволяет не диктовать иерархию наследования объектов предметной области и одновременно (с помощью расширений) дать возможность удобной работы с этими объектами.
