...
статического или динамического способа описания объектного преобразования разнится лишь способ описания их привязки к объектам БД.
...
```
Для корректной работы свойств - ссылок необходимо определить на уровне описания отражения свойства, значения которых будут копироваться из объекта источника в свойства текущего объекта. Это описание различно для статического и динамического способа описания объектного преобразования.
