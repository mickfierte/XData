...
В данном разделе описаны специфичные сценарии использования XData и как их оформить в парадигме статического описания объектного преобразования.

#####Внешние связи
[Внешние связи](./mapping.md#Внешние-связи) в случае использования статического описания объектного преобразования
